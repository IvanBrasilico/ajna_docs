    ...
    def import_named_csv(self, arquivo, session=None, filtro=Filtro.igual):
        ...
        with open(arquivo, 'r') as f:
            ...
            for linha in reader:
                ind = 0
                for coluna in linha:
                    listas[cabecalho[ind]].append([coluna.strip(), filtro])
                    ind += 1
        for key, value in listas:
